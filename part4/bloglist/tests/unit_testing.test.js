...
describe('favorite blog', () => {
  ...
  test('of a bigger list is selected correctly', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, that author has most blogs with a count of 1', () => {
    const result = listHelper.mostBlogs(listWithOneBlog)
    const answer = { author: "Edsger W. Dijkstra", blogs: 1}
    assert.deepStrictEqual(result, answer)
  })

  test('of a bigger list is counted correctly', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, that author has most likes', () => {
    const result = listHelper.mostLikes(listWithOneBlog)
    const answer = { author: "Edsger W. Dijkstra", likes: 5}
    assert.deepStrictEqual(result, answer)
  })
